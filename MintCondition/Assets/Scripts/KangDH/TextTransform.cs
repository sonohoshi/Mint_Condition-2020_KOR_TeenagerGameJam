...
너는 그저 어릴 적 거둬들여져 그들에게 세뇌당한거야!!!"/.../임무 완수를 위해 그를 죽였다*/
            ...
            yield return StartCoroutine(NormalChat("\"ㅈ..잠깐만!\""));
            yield return new WaitForSeconds(1.0f);
            yield return StartCoroutine(NormalChat("타겟인 그가 말을 걸었다."));
            yield return new WaitForSeconds(1.0f);
            backGround.sprite = cut2Image[2];
            yield return StartCoroutine(NormalChat("\"만약 네놈이 데니의 암살자라면, \""));
            yield return new WaitForSeconds(0.3f);
            yield return StartCoroutine(NormalChat("\"네가 알고있는 것은 거짓이야!\""));
            yield return new WaitForSeconds(1.0f);
            yield return StartCoroutine(NormalChat("\"무슨 이야기를 하는거지?\""));
            yield return new WaitForSeconds(1.0f);
            backGround.sprite = cut2Image[3];
            yield return StartCoroutine(NormalChat("\"너는 세계 평화를 위해서도, \""));
            yield return new WaitForSeconds(0.3f);
            yield return StartCoroutine(NormalChat("\"사람들의 목숨을 지키기 위해서 \""));
            yield return new WaitForSeconds(0.3f);
            yield return StartCoroutine(NormalChat("\"싸우는 것도 아니야! \""));
            yield return new WaitForSeconds(0.3f);
            
            yield return new WaitForSeconds(1.0f);
            yield return StartCoroutine(NormalChat("\"너는 그저 어릴 적 \""));
            yield return new WaitForSeconds(0.3f);
            yield return StartCoroutine(NormalChat("\"거둬들여져 그들에게 세뇌당한거야!!!\""));
            yield return new WaitForSeconds(1.0f);
...
*/
            ...
            yield return StartCoroutine(NormalChat("\"세뇌...\""));
            yield return new WaitForSeconds(1.0f);
...
*/
            ...
            yield return StartCoroutine(NormalChat("무슨 짓이야!"));
            yield return new WaitForSeconds(0.5f);
            yield return StartCoroutine(NormalChat("\"네 목표는 내가 아니라고!!\""));
            yield return new WaitForSeconds(1.0f);
            yield return StartCoroutine(NormalChat("나는 그에게 진실을 물었다."));
            yield return new WaitForSeconds(1.0f);
            yield return StartCoroutine(NormalChat("\"ㅁ..뭘원하는거야!? \""));
            yield return new WaitForSeconds(1.0f);
            yield return StartCoroutine(NormalChat("\"네가 아는 모든 것은 진실이야!\""));
            yield return new WaitForSeconds(0.5f);
            yield return StartCoroutine(NormalChat("\"세계는 곧 멸망할거야!\""));
            yield return new WaitForSeconds(1.0f);
            yield return StartCoroutine(NormalChat("\"네가 악한 자들의 목을\""));
            yield return new WaitForSeconds(0.3f);
            yield return StartCoroutine(NormalChat("\"지금처럼 베어내지 않는다면!!!\""));
            yield return new WaitForSeconds(1.0f);
            backGround.sprite = cut4Image[1];
            yield return StartCoroutine(NormalChat("나는 그의 신체 일부를 잘라냈다."));
            yield return new WaitForSeconds(1.0f);
            yield return StartCoroutine(NormalChat("\"으아아아악!!!!\""));
            yield return new WaitForSeconds(1.0f);
            backGround.sprite = cut4Image[2];
            yield return StartCoroutine(NormalChat("\"알겠어, 알겠다고!\""));
            yield return new WaitForSeconds(1.0f);
            yield return StartCoroutine(NormalChat("그가 말을 이어나갔다."));
            yield return new WaitForSeconds(1.0f);
            yield return StartCoroutine(NormalChat("\"넌 세계 평화를 위해서,\""));
            yield return new WaitForSeconds(1.0f);
            yield return StartCoroutine(NormalChat("\"사람들을 지키기 위해서 \n싸우는게 아니야.\""));
            yield return new WaitForSeconds(1.0f);
            yield return StartCoroutine(NormalChat("\"돈, 그래..돈\""));
            yield return new WaitForSeconds(0.7f);
            yield return StartCoroutine(NormalChat("\"데니가 돈을 벌지 못하게 방해하는 자들을\""));
            yield return new WaitForSeconds(0.8f);
            yield return StartCoroutine(NormalChat("\"없애는게 니가 해왔던 임무야.\""));
            yield return new WaitForSeconds(1.0f);
            backGround.sprite = cut4Image[3];
            yield return StartCoroutine(NormalChat("\"그게 어떤 단체든, 군대든, 국가든말이야.\""));
            yield return new WaitForSeconds(1.0f);
            yield return StartCoroutine(NormalChat("\"이게 내가아는 전부야, 용서해줘 젠장!\""));
            yield return new WaitForSeconds(1.0f);
            yield return StartCoroutine(NormalChat("이제 내가 하는 일이 옳다는 것을 알았다"));
            yield return new WaitForSeconds(1.0f);
 ...
 */
            ...
            yield return StartCoroutine(NormalChat("더럽고 피비린내나는 세계와"));
            yield return new WaitForSeconds(0.8f);
